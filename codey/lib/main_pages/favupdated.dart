                    ...
                    builder:(BuildContext context,AsyncSnapshot<QuerySnapshot>snapshot) {
                      ...
                      if(snapshot.connectionState==ConnectionState.active){
                       ...
                       for( var streamData in snapshot.data!.docs){
                         if(favourites[index]==streamData.id){
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Image.asset(a[0]['logo'],fit:BoxFit.fill),
                          ),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                textAlign:TextAlign.center,
                              ''+a[0]['offer']+ '% off'+' on selected merchandise'+'\n'+'Grab it before offer expires',
                                ...
                                return Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          CircleAvatar(
                                            ...
                                            foregroundImage: AssetImage(a[0]['logo'],),
                                          ),
                                      ...
                                      Text(
                                        textAlign:TextAlign.center,
                                       a[0]['offer'].toString()+'% offer on selected items click below to get the offer'),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Center(child: Text(a[0]['offerCode'])),
                                          ),
                                          MaterialButton(
                                            color: Colors.grey,
                                            onPressed: (){},
                      ...
                      return Column(
                        children: [
                          ...
                          Text('Need to code for later in case...issue with connection not active'),
                        ],
                      );
                    })
                    );
